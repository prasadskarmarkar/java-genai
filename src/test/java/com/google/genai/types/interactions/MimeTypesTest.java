...
public class MimeTypesTest {
  ...
  @Test
  public void testMediaResolutionValues() {
    // Test all media resolution enum values
    assertNotNull(MediaResolution.LOW);
    assertNotNull(MediaResolution.MEDIUM);
    assertNotNull(MediaResolution.HIGH);
    assertNotNull(MediaResolution.ULTRA_HIGH);
  }

  @Test
  public void testMediaResolutionValueOf() {
    // Test creating MediaResolution from string
    assertEquals(MediaResolution.LOW, MediaResolution.valueOf("LOW"));
    assertEquals(MediaResolution.MEDIUM, MediaResolution.valueOf("MEDIUM"));
    assertEquals(MediaResolution.HIGH, MediaResolution.valueOf("HIGH"));
    assertEquals(MediaResolution.ULTRA_HIGH, MediaResolution.valueOf("ULTRA_HIGH"));
  }

  @Test
  public void testMediaResolutionToString() {
    // Test toString returns the enum name
    assertEquals("LOW", MediaResolution.LOW.toString());
    assertEquals("MEDIUM", MediaResolution.MEDIUM.toString());
    assertEquals("HIGH", MediaResolution.HIGH.toString());
    assertEquals("ULTRA_HIGH", MediaResolution.ULTRA_HIGH.toString());
  }
