 ...
 * async coverage of all Interactions API features. All tests use CompletableFuture and .join() for
 * async operations, with CompletionException handling for errors.
 *
...
public class AsyncInteractionsComprehensiveTest {
  ...
  public void testCancelAsync_backgroundInteraction(boolean vertexAI) throws Exception {
    ...
    // Act
    CompletableFuture<Interaction> future = client.async.interactions.cancel(interactionId, config);
    Interaction interaction = future.join();
  ...
  public void testDeleteAsync_existingInteraction(boolean vertexAI) throws Exception {
    ...
    Client client =
        TestUtils.createClient(
            vertexAI, "tests/interactions/comprehensive_async/delete_existing." + suffix + ".json");
  ...
  public void testCreateAsync_withGenerationConfig(boolean vertexAI) throws Exception {
    ...
    Client client =
        TestUtils.createClient(
            vertexAI,
            "tests/interactions/comprehensive_async/create_generation_config." + suffix + ".json");
  ...
  public void testCreateAsync_withSystemInstruction(boolean vertexAI) throws Exception {
    ...
    Client client =
        TestUtils.createClient(
            vertexAI,
            "tests/interactions/comprehensive_async/create_system_instruction." + suffix + ".json");
  ...
  public void testCreateAsync_withResponseMimeType(boolean vertexAI) throws Exception {
    ...
    Client client =
        TestUtils.createClient(
            vertexAI,
            "tests/interactions/comprehensive_async/create_response_mime_type." + suffix + ".json");
  ...
  public void testCreateAsync_withAgentConfig(boolean vertexAI) throws Exception {
    ...
    Client client =
        TestUtils.createClient(
            vertexAI,
            "tests/interactions/comprehensive_async/create_with_agent_config." + suffix + ".json");
  ...
  public void testCreateAsync_withAudioContent(boolean vertexAI) throws Exception {
    ...
    AudioContent audioContent = AudioContent.builder().uri("gs://test-bucket/audio.mp3").build();
  ...
  public void testCreateAsync_withVideoContent(boolean vertexAI) throws Exception {
    ...
    VideoContent videoContent = VideoContent.builder().uri("gs://test-bucket/video.mp4").build();
  ...
  public void testGetAsync_notFound_completionException(boolean vertexAI) throws Exception {
    ...
    Client client =
        TestUtils.createClient(
            vertexAI, "tests/interactions/comprehensive_async/get_not_found." + suffix + ".json");
  ...
  public void testCancelAsync_alreadyCancelled_completionException(boolean vertexAI)
    ...
    Client client =
        TestUtils.createClient(
            vertexAI,
            "tests/interactions/comprehensive_async/cancel_already_cancelled." + suffix + ".json");
    ...
    // Act & Assert
    CompletableFuture<Interaction> future = client.async.interactions.cancel(cancelledId, config);
    assertThrows(CompletionException.class, () -> future.join());
  }
