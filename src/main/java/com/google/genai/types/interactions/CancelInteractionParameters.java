...
public abstract class CancelInteractionParameters extends JsonSerializable {
  ...
  @JsonProperty("config")
  public abstract Optional<CancelInteractionConfig> config();
  ...
  public abstract static class Builder {
     ...
     * Setter for id.
     *
     * <p>id: The ID of the interaction to cancel.
     */
    @JsonProperty("id")
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Builder config(Optional<CancelInteractionConfig> config);
