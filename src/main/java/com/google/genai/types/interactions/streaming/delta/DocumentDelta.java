...
/**
 * Represents an incremental document update in a streaming response.
 *
 * <p>Note: The Interactions API is in beta and subject to change.
 */
@AutoValue
@JsonDeserialize(builder = DocumentDelta.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("document")
public abstract class DocumentDelta extends JsonSerializable implements Delta {

  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DocumentDelta.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract DocumentDelta build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static DocumentDelta fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DocumentDelta.class);
  }
}
