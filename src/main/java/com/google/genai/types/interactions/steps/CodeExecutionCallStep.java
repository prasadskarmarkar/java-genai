...
@AutoValue
@JsonDeserialize(builder = CodeExecutionCallStep.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("code_execution_call")
public abstract class CodeExecutionCallStep extends JsonSerializable implements Step {
  ...
  public static Builder builder() {
    return new AutoValue_CodeExecutionCallStep.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract CodeExecutionCallStep build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static CodeExecutionCallStep fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, CodeExecutionCallStep.class);
  }
}
