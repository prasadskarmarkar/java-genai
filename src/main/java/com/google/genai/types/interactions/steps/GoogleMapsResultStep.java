 ...
 *
 * <p>The {@code result} field is typed as {@code Object} due to the complex nested structure of
 * Google Maps result items (places with widget context tokens).
 */
@AutoValue
@JsonDeserialize(builder = GoogleMapsResultStep.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("google_maps_result")
public abstract class GoogleMapsResultStep extends JsonSerializable implements Step {
  ...
  public static Builder builder() {
    return new AutoValue_GoogleMapsResultStep.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract GoogleMapsResultStep build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static GoogleMapsResultStep fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, GoogleMapsResultStep.class);
  }
}
