...
/**
 * Result of a function tool call step.
 *
 * <p>The {@code result} field is typed as {@code Object} because the spec defines it as
 * {@code oneOf [object, array<ImageContent|TextContent>, string]}.
 */
@AutoValue
@JsonDeserialize(builder = FunctionResultStep.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("function_result")
public abstract class FunctionResultStep extends JsonSerializable implements Step {
  ...
  public static Builder builder() {
    return new AutoValue_FunctionResultStep.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract FunctionResultStep build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static FunctionResultStep fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, FunctionResultStep.class);
  }
}
