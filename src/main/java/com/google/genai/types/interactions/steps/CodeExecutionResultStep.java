...
@AutoValue
@JsonDeserialize(builder = CodeExecutionResultStep.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("code_execution_result")
public abstract class CodeExecutionResultStep extends JsonSerializable implements Step {
  ...
  public static Builder builder() {
    return new AutoValue_CodeExecutionResultStep.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract CodeExecutionResultStep build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static CodeExecutionResultStep fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, CodeExecutionResultStep.class);
  }
}
