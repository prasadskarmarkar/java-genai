...
/**
 * Represents an incremental Google Search result update in a streaming response.
 *
 * <p>Note: The Interactions API is in beta and subject to change.
 */
@AutoValue
@JsonDeserialize(builder = GoogleSearchResultDelta.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("google_search_result")
public abstract class GoogleSearchResultDelta extends JsonSerializable implements Delta {

  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GoogleSearchResultDelta.Builder();
  }
  ...
  /** Returns the result of the Google Search call. */
  @JsonProperty("result")
  public abstract Optional<List<GoogleSearchResult>> result();

  /** Returns the signature of the result. */
  ...
  public abstract static class Builder {
    ...
    public abstract GoogleSearchResultDelta build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static GoogleSearchResultDelta fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, GoogleSearchResultDelta.class);
  }
}
