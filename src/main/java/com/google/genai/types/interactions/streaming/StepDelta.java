...
/** Event containing an incremental step-level update in a streaming interaction. */
@AutoValue
@JsonDeserialize(builder = StepDelta.Builder.class)
@JsonTypeInfo(
    use = JsonTypeInfo.Id.NAME,
    include = JsonTypeInfo.As.PROPERTY,
    property = "event_type")
@JsonTypeName("step.delta")
public abstract class StepDelta extends JsonSerializable implements InteractionSseEvent {
  ...
  public static Builder builder() {
    return new AutoValue_StepDelta.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract StepDelta build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static StepDelta fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, StepDelta.class);
  }
}
