...
@AutoValue
@JsonDeserialize(builder = McpServerToolCallStep.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("mcp_server_tool_call")
public abstract class McpServerToolCallStep extends JsonSerializable implements Step {
  ...
  public static Builder builder() {
    return new AutoValue_McpServerToolCallStep.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract McpServerToolCallStep build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static McpServerToolCallStep fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, McpServerToolCallStep.class);
  }
}
