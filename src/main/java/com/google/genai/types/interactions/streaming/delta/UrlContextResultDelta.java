...
/**
 * Represents an incremental URL context result update in a streaming response.
 *
 * <p>Note: The Interactions API is in beta and subject to change.
 */
@AutoValue
@JsonDeserialize(builder = UrlContextResultDelta.Builder.class)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
@JsonTypeName("url_context_result")
public abstract class UrlContextResultDelta extends JsonSerializable implements Delta {

  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_UrlContextResultDelta.Builder();
  }
  ...
  /** Returns the result of the URL context call. */
  @JsonProperty("result")
  ...
  public abstract static class Builder {
    ...
    public abstract UrlContextResultDelta build();
  }

  @ExcludeFromGeneratedCoverageReport
  public static UrlContextResultDelta fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, UrlContextResultDelta.class);
  }
}
