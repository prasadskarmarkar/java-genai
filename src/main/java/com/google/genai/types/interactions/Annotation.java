 ...
 *
 * <p>Annotations provide attribution for specific segments of text by mapping byte indices
 * to their source references (such as URLs or titles).
 */
@AutoValue
...
public abstract class Annotation extends JsonSerializable {
   ...
   * Index indicates the end of the segment, measured in bytes.
   */
