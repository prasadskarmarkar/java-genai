 ...
 * <p>mvn clean compile
 *
 * <p>mvn exec:java -Dexec.mainClass="com.google.genai.examples.InteractionsStreamingDocumentContent"
 */
 ...
 * <ul>
 *   <li>Using DocumentContent.fromUri() to analyze a document from a URL with streaming
 *   <li>Using DocumentContent.fromData() to analyze base64-encoded documents with streaming
 *   <li>Receiving document analysis results incrementally as they are generated
 * </ul>
 *
...
public final class InteractionsStreamingDocumentContent {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // ===== PART 2: Document from Inline Data (Base64) Streaming =====
      System.out.println("--- PART 2: Document from Inline Data (Base64) Streaming ---\n");
  ...
  private InteractionsStreamingDocumentContent() {}
}
