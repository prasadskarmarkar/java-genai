 ...
 * <p>mvn clean compile
 *
 * <p>mvn exec:java -Dexec.mainClass="com.google.genai.examples.InteractionsStreamingImageContent"
 */
 ...
 * <ul>
 *   <li>Using ImageContent.fromUri() to analyze an image from a URL with streaming
 *   <li>Using ImageContent.fromData() to analyze a base64-encoded image with streaming
 *   <li>Receiving text responses incrementally as they are generated
 * </ul>
 *
...
public final class InteractionsStreamingImageContent {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // ===== PART 2: Image from Inline Data (Base64) Streaming =====
      System.out.println("--- PART 2: Image from Inline Data (Base64) Streaming ---\n");
      ...
      // Using simplified streaming API
  ...
  private InteractionsStreamingImageContent() {}
}
