 ...
 * <p>mvn clean compile
 *
 * <p>mvn exec:java -Dexec.mainClass="com.google.genai.examples.InteractionsStreamingUrlContext"
 */
 ...
 *
 * <p>Demonstrates how to use the UrlContext tool with streaming to enable the model
 * to fetch and use content from URLs, receiving results incrementally.
 *
 * <p>This example shows:
 * <ul>
 *   <li>Enabling URL Context tool with streaming
 *   <li>Handling UrlContextCallDelta for URL fetch updates
 *   <li>Handling UrlContextResultDelta for fetch result updates
...
public final class InteractionsStreamingUrlContext {
        ...
        for (InteractionSseEvent event : stream) {
          ...
          if (event instanceof InteractionEvent) {
            ...
            if (delta instanceof UrlContextCallDelta) {
              ...
              urlDelta.arguments().ifPresent(arguments -> {
                System.out.println("  Arguments:");
                arguments.urls().ifPresent(urls ->
                    System.out.println("    URLs: " + urls));
              });
            } else if (delta instanceof UrlContextResultDelta) {
              urlResultDeltaCount++;
              UrlContextResultDelta resultDelta = (UrlContextResultDelta) delta;
  ...
  private InteractionsStreamingUrlContext() {}
}
